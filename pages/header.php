    ...
    <body>
		...
		<div class="modalBG" id="loginModalBG">
       	...
       	<div class="modalBG" id="useTermsModalBG">
			<div class="fold light clearfix" style="height: 500px; overflow: scroll;">
				<div class="fold-header">
					<h4 class="lead"><i class="fas fa-asterisk"></i> Use terms</h4>
					<i class="fas fa-times fa-lg" id="useTermsModalCloseBtn"></i>
				</div>
				<p class="pull-left" style="padding: 5px; background-color: var(--lightColorDarken); border-radius; 5px;">Apache License
